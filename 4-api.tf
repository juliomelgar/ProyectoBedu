...
# -------------------------------------------------------------------
# Aqui utilizamos el cognito user pool
# -------------------------------------------------------------------
...
# ----------------------------------------------------
# Permitir invocar la lambda por el API
# ----------------------------------------------------
